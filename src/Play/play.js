...
const Play = (props) => {
      ...
      .then((response) => {
        ...
        if (response.data.sucess === true) {
          setsaveProgress((previous) => {
            return {
              ...previous,
              setTime: response.data.data[0].setTime,
              setCount: response.data.data[0].setCount,
            };
          });
        }
      })
    ...
    settimeoutb2.current = setTimeout(() => {
      ...
      if (j === 0) {
        ...
        setsaveProgress((previous) => {
          return {
            ...previous,
            setTime: previous.setTime + TotalSetTime,
            setCount: previous.setCount + 1,
          };
        });
      } else {
        short(value);
  ...
  return (
    <>
      ...
      <ProgressBar
        taskdone={saveProgress.setCount}
