...
const GoalSet = (props) => {
  ...
  let setGoalTime =
    (props.selecttime[level].a1 + props.selecttime[level].a2) *
      props.selecttime[level].a3 +
    (props.selecttime[level].b1 + props.selecttime[level].b2) *
      props.selecttime[level].b3;
  const handleGoals = (e) => {
